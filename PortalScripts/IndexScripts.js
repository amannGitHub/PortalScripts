...
function UpdateSearchLocation() {
    ...
    $("#searchicon").css({ top: position.top - 40, left: position.left + 150, position: 'absolute' });
}
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            for (i = 0; i < len; i++) {
                ...
                if (i == 0) {
                    classText = '<div class="carousel-item active">';

                }
                else {
                    classText = '<div class="carousel-item">';
                    Olhtml += ' <li id="clitem' + i + '" data-target="#myCarousel" data-slide-to="' + i + '" class=""></li>' + '\n';
...
function getDashGatewayDiv() {
    return ' <div class="card" id="dashgateway">'
        ...
        + '\n <h5 class="mb-0"> '
        + '\n   <a class="card-title" data-parent="#accordion"data-target="#collapseDashGateway" data-toggle="collapse" href="collapseDashGateway" area-controls="collapseDashGateway" aria-expanded="true">'
...
function getReportGatewayDiv() {
    var ReportGatewayDiv =
        ...
        + '\n     <div class="card-header" role="tab" id="NewReportButton">'
        + '\n <h5 class="mb-0"> '
        + '\n   <a class="card-title" data-parent="#accordion"data-target="#collapseReportGateway" data-toggle="collapse" href="collapseReportGateway" area-controls="collapseReportGateway" aria-expanded="true">'
        + 'Create New Report'
        + '\n   </a> '
        + '\n </h5> '
        + '\n      </div>'
...
function makeDashboardAccordion(cat) {
    ...
    return ' <div class="card" id="' + catNoSpaces + "card" + '">'
        ...
        + '\n <h5 class="mb-0"> '
        + '\n   <a class="card-title" data-parent="#accordion" data-target="#collapse' + catNoSpaces + '"' + 'data-toggle="collapse" href=' + "collapse" + catNoSpaces + ' area-controls="' + "collapse" + catNoSpaces + '"' + 'aria-expanded="true">'
        +       cat
        + '\n   </a> '
        + '\n </h5> '
        + '\n </div >'
...
function makeDashboardFavsAccordion(cat) {
    ...
    return ' <div class="card" id="' + catNoSpaces + "card" + '">'
        + '\n <div class="card-header" role="tab" id="' + catNoSpaces + "Header" + '"' + '>'
        + '\n <h5 class="mb-0"> '
        + '\n   <a class="card-title" data-parent="#accordion" data-target="#collapseFavDashs' + catNoSpaces + '"' + 'data-toggle="collapse" href=' + "collapse" + catNoSpaces + ' area-controls="' + "collapseFavDashs" + catNoSpaces + '"' + 'aria-expanded="true">'
        + cat
        + '\n   </a> '
        + '\n </h5> '
        + '\n </div >'
...
function makeReportFavsAccordion(cat) {
    ...
    return ' <div class="card" id="' + catNoSpaces + "card" + '">'
        + '\n <div class="card-header" role="tab" id="' + catNoSpaces + "Header" + '"' + '>'
        + '\n <h5 class="mb-0"> '
        + '\n   <a class="card-title" data-parent="#accordion" data-target="#collapseFavReport' + catNoSpaces + '"' + 'data-toggle="collapse" href=' + "collapse" + catNoSpaces + ' area-controls="' + "collapseFavReport" + catNoSpaces + '"' + 'aria-expanded="true">'
        + cat
        + '\n   </a> '
        + '\n </h5> '
...
function makeReportAccordion(cat, catDescription) {
    catNoSpaces = getCatNoSpaces(cat);
    return ' <div class="card" id="' + catNoSpaces + "card" + '">'
        + '\n <div class="card-header" role="tab" id="' + catNoSpaces + "Header" + '"' + '>'
        + '\n <h5 class="mb-0"> '
...
function makeReportSearchAccordion(cat) {
    ...
    return ' <div class="card" id="' + catNoSpaces + "card" + '">'
        ...
        + '\n <h5 class="mb-0"> '
        + '\n   <a class="card-title" data-parent="#accordion" data-target="#collapseSearchReports' + catNoSpaces + '"' + 'data-toggle="collapse" href=' + "collapseSearchReports" + catNoSpaces + ' area-controls="' + "collapseSearchReports" + catNoSpaces + '"' + 'aria-expanded="true">'
        + cat
        + '\n   </a> '
        + '\n </h5> '
        + '\n </div >'
...
function makeDashboardSearchAccordion(cat) {
    ...
    return ' <div class="card" id="' + catNoSpaces + "card" + '">'
        + '\n <div class="card-header" role="tab" id="' + catNoSpaces + "Header" + '"' + '>'
        + '\n <h5 class="mb-0"> '
        + '\n   <a class="card-title" data-parent="#accordion" data-target="#collapseSearchDashs' + catNoSpaces + '"' + 'data-toggle="collapse" href=' + "collapseSearchDashs" + catNoSpaces + ' area-controls="' + "collapseSearchDashs" + catNoSpaces + '"' + 'aria-expanded="true">'
        + cat
        + '\n   </a> '
        + '\n </h5> '
        + '\n </div >'
   ...
   ReportGatewayDiv = getReportGatewayDiv();
    $.ajax({
        ...
        success: function (data) {
            ...
            arr2 = $.map(data, function (p) { return p.ParentDescription });
            myCatsDescription = $.distinct(arr2);
            var ReportCatsDescription = "";

            for (i = 0; i < myCats.length; i++) {
                var catNoSpaces = getCatNoSpaces(myCats[i]);
                var catsUrlAdd = myCats[i].replace(' ', '%20');

                /*ReportCatsDescription = getCategoryDescription(myCats[i]);*/
                //ReportCatsHtml += makeReportAccordion(myCats[i], myCatsDescription[i]);
                ReportCatsHtml += makeReportAccordion(myCats[i], myCatsDescription[i]);
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.length > 0) {
                ...
                $("#searchDashboardsAccordion").hide();
                //$("#dashSearchTab").hide();
